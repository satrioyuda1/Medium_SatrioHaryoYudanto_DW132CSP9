    ...
    return (
      <div>
        ...
        <Grid container spacing={3} direction="row" marginTop="50px">
                <Grid item lg={4}>
                    <div>
                        <img style={{ maxWidth: "100%", height: "auto" }}src="https://miro.medium.com/max/700/1*2T7qo9te-cfMhFJpwIUNig.jpeg" />
                ...
                <Grid item lg={4}>
                    <List>
                        <ListItem alignItems="flex-start">
                            <img style={{maxWidth:"50%",height:'auto',marginLeft: '10px', marginRight: '10px', }} src="https://miro.medium.com/max/1600/1*SaFOFV_pvECKdyOXVUTqXA.jpeg"/>
                            <ListItemText
                        ...
                        <List>
                            <ListItem alignItems="flex-start">
                                <img style={{maxWidth:"50%",height:'auto', marginLeft: '10px', marginRight: '10px', }} src="https://miro.medium.com/max/1024/0*5hzTkPxWTEQgMhub.jpg"/>
                                <ListItemText
                                    primary="Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.?"
                                    secondary={
                                        <React.Fragment>
                        ...
                        <List>
                            <ListItem alignItems="flex-start">
                                <img style={{maxWidth:"50%",height:'auto', marginLeft: '10px', marginRight: '10px', }} src="https://miro.medium.com/max/1600/1*Cplec4Kp4kips8lvyQZLKw.png"/>
                                <ListItemText
                                    primary="Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.?"
                                    secondary={
                                        <React.Fragment>
                ...
                <Grid item lg={4}>
                    <div >
                         <img style={{ maxWidth: "100%", height: "auto" }}src="https://miro.medium.com/max/3888/0*su9uMau9M7wwmluM" />
                        <Typography  variant="h5" align="Left">
                          7 Reasons Why Smart, Hardworking People Don’t Become Successful 
                         </Typography>
                      <Typography variant="subtitle2" align="justify">
        ...
        <Grid container spacing={3} direction="row">
            <Grid item lg={7}>
                ...
                <List>
                    ...
                    />
                    <img style={{maxWidth:"auto",height:'30%', marginLeft: '10px', marginRight: '10px', }} src=" https://i.pinimg.com/236x/10/31/a8/1031a881880373587a0453d73b54ce67.jpg"/>        
                 </ListItem>
                </List> 
            </Grid>
